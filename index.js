...
async function Redis_work(){
    ...
    const [res1, val1] = await client.sendCommand(['GEOADD', 'Circle 13.361389 38.115556 Palermo 15.087269 37.502669 Catania'])
    const [res2, val2] = await client.sendCommand(['GEORADIUS', 'Circle 15 37 200 km WITHCOORD'])
    console.log(res1)
    console.log(res2)
    return val2
}
